...
public class CalculationUtil {
	...
	public static BigDecimal calculateMean(List<BigDecimal> bigDecimals, int roundingMode) throws Exception {
		...
		BigDecimal[] totalWithCount = bigDecimals.stream().filter(bd -> bd != null)
	...
	/*
	 * Select most common element- if multiple elements occur the same number of
	 * times take the first in the sorted list
	 */
